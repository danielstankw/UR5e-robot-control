...
#     # Discard the oldest value from the top
#     array.pop(0)
...
#
#                 # ML related - switch if:
#                 # a) We establish contact b) Its 1 sec after contact
#                 if contact_flag and t_curr >= contact_time + 1.5:
#                     cnt += 1
#                     features = f_int[:5].tolist()  # fx,fy,fz,mx,my
...
#                             # j += 1
#
#                     #     print('Model detected overlap', model_overlap)
...
def run_robot_spiral_ml(robot, start_pose, pose_desired, pose_error, control_dim, use_impedance, plot_graphs, circle,
    ...
    model = keras.models.load_model('/home/danieln7/Desktop/RobotCode2023/ml_models/sim_feb8_full')
    threshold = 0.5
